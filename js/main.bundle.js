...
;// CONCATENATED MODULE: ./blocks/header/img/logo.svg
const logo_namespaceObject = __webpack_require__.p + "static/logo.svg";
;// CONCATENATED MODULE: ./blocks/services/img/item1.jpg
const item1_namespaceObject = __webpack_require__.p + "static/item1.jpg";
...
function runSwipers(classNameContainer, ClassNamePagination, dataName) {
    let swipers = document.querySelectorAll(classNameContainer);

    for (let i = 1; i <= swipers.length; i++) {
        new core(`${classNameContainer}[${dataName}="${i}"]`, 
            {
                modules: [Pagination],
                pagination: {
...
;// CONCATENATED MODULE: ./js/repair.js
...
function repairFill(massData, generalClass, classContent, swipSetting) {
...
;// CONCATENATED MODULE: ./js/uncover.js
function generateParamsHeights(mass) {
...
function modals(bodyClass, bodyNoScrollClass) {
    function closeModal(data) {
        ...
        modalFon.removeAttribute("data-modal");

        modal.classList.remove('modal--open');
            
        modalFon.classList.remove('modal-fon--open');
        bodySite.classList.remove(bodyNoScrollClass);
    }

    let bodySite = document.querySelector(bodyClass);

    let modalFon = document.querySelector('.modal-fon');
    ...
    for (let i = 0; i < modalOpen.length; i++) {
        modalOpen[i].addEventListener('click', function (e) {
            ...
            modalFon.classList.add('modal-fon--open');
    ...
    document.addEventListener('click', function (e) {
        ...
        var modalActive = modalFon.classList.contains('modal-fon--open');
...
for (let i = 0; i < logo.length; i++) {
    logo[i].src = logo_namespaceObject;
    logo[i].alt = "Логотип компании";
}

Item.src = item1_namespaceObject;
...
runSwipers('.swiper-container', '.swiper-pagination', 'data-swiper');
...
repairFill(js_data, 'repair', '.repair__item-info', swipSetting);
...
window.addEventListener("resize", function () {
    generateParamsHeights(mass);

    if (document.querySelector('body').clientWidth >= 1440) {
        if (menu.classList.contains('modal--open')) {
...
modals('.body-site', 'body-site--no-scroll');
})();
